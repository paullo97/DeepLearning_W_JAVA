...
public class Word2VecDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Collection<String> crianca = word2VecModel.wordsNearest("fatec" , 10);
        System.out.println("fatec: " + crianca);

        Collection<String> alcool = word2VecModel.wordsNearest("cursos", 10);
        System.out.println("cursos: " + alcool);
